...
reimplement or approximate combat mechanics. It loads `ContentManifestV1` from
the embedded package through `sls2_call_v1`, so package identity and supported
combat content are not duplicated in TypeScript.
