# Archived STS2 Combat Oracle Bridge

This bridge is historical evidence only. It is excluded from the active Rust
workspace and no active command depends on it.
